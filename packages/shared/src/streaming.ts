...
export interface StreamChunk {
  type: StreamChunkType | 'error' | 'content_delta' | 'content_start' | 'content_end' | 'content' | 'message_start' | 'message_end' | 'message' | 'tool_input_start' | 'tool_input_delta' | 'tool_input_end' | 'tool_call' | 'tool_result' | 'reasoning_start' | 'reasoning_delta' | 'reasoning_end' | 'step_start' | 'step_end';
