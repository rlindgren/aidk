...
describe('ExecutionGraph', () => {
  ...
  describe('outstanding forks', () => {
    it('should get outstanding forks (running children)', () => {
      ...
      fork1.complete({ timeline: [], sections: {}, tools: [], metadata: {}, ephemeral: [], system: [] });
  ...
  describe('orphaned forks', () => {
    it('should detect orphaned forks (parent completed, child running)', () => {
      ...
      parentHandle.complete({ timeline: [], sections: {}, tools: [], metadata: {}, ephemeral: [], system: [] });
    ...
    it('should not include completed forks as orphaned', () => {
      ...
      forkHandle.complete({ timeline: [], sections: {}, tools: [], metadata: {}, ephemeral: [], system: [] });
  ...
  describe('queries', () => {
    ...
    it('should get executions by status', () => {
      ...
      completed.complete({ timeline: [], sections: {}, tools: [], metadata: {}, ephemeral: [], system: [] });
