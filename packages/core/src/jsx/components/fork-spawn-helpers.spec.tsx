...
describe('Fork/Spawn Helper Functions', () => {
  ...
  describe('createForkHandle', () => {
    it('should create a fork handle with agent prop', async () => {
      const forkAgent = {
        render: () => (
          <>
            <Message role="user" content="Fork agent" />
          </>
        )
      };
    ...
    it('should call onError handler when spawn fails', async () => {
      ...
      try {
        await errorEngine.execute.call(
          { timeline: [] },
          <SpawnCreator />
        );
      } catch (_e) {
        ...
        render(com: COM, state: TickState) {
          expect(() => {
            createForkHandle(
              ...
              {
                input: { timeline: [] }
                // No agent or children
              }
            );
          }).toThrow(/agent or children must be provided/);
  ...
  describe('createSpawnHandle', () => {
    it('should create a spawn handle with agent prop', async () => {
      const spawnAgent = {
        render: () => (
          <>
