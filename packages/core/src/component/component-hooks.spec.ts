...
describe('ComponentHookRegistry', () => {
  ...
  describe('register overloads', () => {
    it('should register middleware for specific hook and specific component', () => {
      ...
      const middlewareList = registry.getMiddleware('onTickStart', TimelineManager, 'TimelineManager', []);
    ...
    it('should register middleware for specific hook and all components', () => {
      ...
      const middlewareList = registry.getMiddleware('onTickStart', AnyComponent, 'AnyComponent', []);
      expect(middlewareList).toHaveLength(1);
      expect(middlewareList[0]).toBe(middleware);
    });
    ...
    it('should register middleware for all hooks and specific component', () => {
      ...
      const onTickStartMw = registry.getMiddleware('onTickStart', TimelineManager, 'TimelineManager', []);
      const renderMw = registry.getMiddleware('render', TimelineManager, 'TimelineManager', []);
      const onTickEndMw = registry.getMiddleware('onTickEnd', TimelineManager, 'TimelineManager', []);
    ...
    it('should combine multiple registrations correctly', () => {
      ...
      const timelineMw = registry.getMiddleware('onTickStart', TimelineManager, 'TimelineManager', []);
    ...
    it('should handle tag selector', () => {
      ...
      const middlewareList = registry.getMiddleware('onTickStart', TimelineManager, 'TimelineManager', ['timeline', 'manager']);
      expect(middlewareList).toHaveLength(1);
      expect(middlewareList[0]).toBe(middleware);
    });
  });
