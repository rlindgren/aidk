...
describe('Compiler Integration', () => {
  ...
  describe('Mixed Function and Class Components', () => {
    it('should compile mixed component tree', async () => {
      ...
      const element = createElement(FunctionWrapper, {},
        createElement(ClassContent, {})
      );
  ...
  describe('Lifecycle Integration', () => {
    ...
    it('should handle class component lifecycle', async () => {
      ...
      class LifecycleComponent extends Component {
        ...
        onTickStart = () => { order.push('class-tick-start'); };
        onTickEnd = () => { order.push('class-tick-end'); };
  ...
  describe('Reconciliation', () => {
    ...
    it('should handle key changes', async () => {
      ...
      const element1 = createElement('div', {},
        createElement(Item, { id: 'first', key: '1' })
      );
      
      await compiler.compile(element1, tickState);
      
      const element2 = createElement('div', {},
        createElement(Item, { id: 'second', key: '2' })
      );
