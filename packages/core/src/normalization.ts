...
import type { ModelConfig, ModelInput, ModelToolReference, NormalizedModelInput, NormalizedModelTool } from './model/model';
...
function isToolMetadata(obj: any): obj is ToolMetadata {
  return obj && typeof obj === 'object' && 'name' in obj && 'description' in obj && 'parameters' in obj;
}
